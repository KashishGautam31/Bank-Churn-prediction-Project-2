...
st.markdown("""
    ...
    /* ⬛ BLACK BOXES FOR ALL INPUTS (To fix visibility issues in light themes) */
    ...
    /* Make text inside file uploader explicitly white */
    [data-testid="stFileUploaderDropzone"] * {
        color: #FFFFFF !important;
    }

    /* Make dropdown options dark with white text */
    ...
    /* 🟢🔴 PREMIUM TABS STYLING WITH PERFECT ALIGNMENT */
    div[data-testid="stTabs"] {
        background-color: transparent !important;
    }
    div[data-testid="stTabs"] button {
        flex: 1 !important; /* Makes tabs stretch equally 50-50 */
        justify-content: center !important; /* Centers the text inside tabs */
    ...
    div[data-baseweb="tab-panel"] {
        ...
        border-radius: 0 0 8px 8px; /* Fixed radius to align smoothly */
        padding: 25px;
        margin-top: -1px;
    }
    </style>
...
if not st.session_state['logged_in']:
    st.markdown("""
        ...
        /* 
           IMPOSING BACKGROUND: 
           This URL explicitly shows multiple corporate people walking/leaving inside a modern bank/office building.
           The linear-gradient is pure DARK GREY to give it a cinematic, serious "Churn" effect (No Pink). 
        */
        .stApp {
            background: linear-gradient(135deg, rgba(20, 20, 25, 0.88) 0%, rgba(70, 75, 80, 0.85) 100%), 
                        url('https://images.unsplash.com/photo-1556761175-4b46a572b786?q=80&w=2000&auto=format&fit=crop') !important;
            background-size: cover !important;
            background-position: center !important;
            background-attachment: fixed !important;
        }
        
        /* Frosted Glass effect for the Login Box (Dark Grey to match theme) */
        ...
        /* GREY/SLATE TAB specifically for Login to match the new cinematic grey theme */
        div[data-testid="stTabs"] button[aria-selected="true"] {
    ...
    with col2:
        st.markdown("<h2 class='main-title' style='text-align: center; background: linear-gradient(90deg, #94A3B8, #E2E8F0); -webkit-background-clip: text; -webkit-text-fill-color: transparent;'>🏦 Bank ChurnGuard AI</h2>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center; color: #CBD5E1; font-size:16px; margin-bottom: 30px;'>Predictive Risk & Attrition Portal</p>", unsafe_allow_html=True)
...
if page == "Single Profile Risk":
    # -------------------------------------------------------------
    # 🏦 PREDICTIVE INTELLIGENCE BANNER (WITH EMOJI, COLOR & OPACITY)
    # -------------------------------------------------------------
    st.markdown("""
        <div style="margin-top: 15px; margin-bottom: 40px; text-align: center; display: flex; flex-direction: column; align-items: center;">
            <div style="display: inline-flex; align-items: center; padding-bottom: 12px; border-bottom: 2px solid rgba(147, 197, 253, 0.3); margin-bottom: 25px;">
                <span style="font-size: 30px; margin-right: 15px;">🏦</span>
                <span style="color: rgba(147, 197, 253, 0.85); font-weight: 900; font-size: 28px; letter-spacing: 2.5px;">PREDICTIVE INTELLIGENCE</span>
            </div>
...
# ==========================================
    ...
    # ==============================================================
    # DISCLAIMER ADDED HERE AS REQUESTED
    # ==============================================================
    st.info("""
    ⚠️ **DISCLAIMER: REQUIRED CSV FORMAT**
